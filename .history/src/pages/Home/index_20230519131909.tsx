    ...
    <div>
      ...
      <BackgroundImage>
        <Content>
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi. Sed hendrerit faucibus dolor nec ultrices. In id tortor ac sem feugiat aliquam. Vestibulum feugiat sem ac purus hendrerit, ac interdum velit viverra.</p>
        </Content>
      </BackgroundImage>
